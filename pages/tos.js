  ...
  return (
    <div className='max-w-5xl container mx-auto flex flex-col gap-y-2 items-start py-8 px-4 sm:px-1.5'>
      ...
      <p className='font-normal text-base'>
          HOTASM provides the {process.env.NEXT_PUBLIC_BASE_PATH} website and various related services to you, the User, subject to your compliance with all the terms, conditions, and notices contained or referenced herein, as well as any other written agreement between us and you.
      </p>
      <p className='font-normal text-base'>
      ...
      <p className='font-normal text-base'>
          All custom graphics, icons, logos, and service names used on the Website are registered trademarks, service marks, and/or artwork held under copyright of HOTASM or its Affiliates. All other marks are property of their respective owners. Nothing in these Terms of Service grants you any right to use any trademark, service mark, logo, and/or the name or trade names of HOTASM or its Affiliates.
      </p><h2 className='font-bold text-lg'>
          Disclaimer of Warranties
      </h2>
      <p className='font-normal text-base'>
          Content available through this Website often represents the opinions and judgments of an information provider, site user, or other person or entity not connected with us. We do not endorse, nor are we responsible for the accuracy or reliability of, any opinion, advice, or statement made by anyone other than an authorized HOTASM spokesperson speaking in his/her official capacity. Please refer to the specific editorial policies posted on various sections of this Website for further information, which policies are incorporated by reference into these Terms of Service.
      </p>
      <p className='font-normal text-base'>
