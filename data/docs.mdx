...
```
0 21:21 20:5 4:0;		-- [co] [r_co] [r_k] [r_rd]
1 21:21 14:10 9:5 4:0;  -- [co] [r_co] [r_ra] [r_rb] [r_rd]
```
...
#### Configuration
```
mov #K rd; 0 21:21 21:5 4:0;
add ra rb rd; 1 21:21 15:10 9:5 4:0;
```
```
INST: 22 bits
```
